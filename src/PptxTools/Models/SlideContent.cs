...
/// <param name="LayoutName">Name of the slide layout applied to this slide, when available.</param>
/// <param name="LayoutIndex">Zero-based index of the slide layout from <c>pptx_list_layouts</c>, when available.</param>
/// <param name="SlideWidthEmu">Slide width in EMUs as declared in the presentation (typically 9144000 for 10 inches).</param>
/// <param name="SlideHeightEmu">Slide height in EMUs (typically 6858000 for 7.5 inches in 4:3 aspect ratio, or 5143500 for 5.625 inches in 16:9).</param>
